...
var constants = function () {
	...
	this.AUTH_URL = `${this.POST_HOST}connect/oauth2/authorize?appid=${env.WEI_XIN_APP_ID}&redirect_uri=${encodeURIComponent(env.REDIRECT_URI)}&response_type=code&scope=snsapi_base&state=test11#wechat_redirect`;
	this.getAuthAccessUrl = function (code) {
		return `${this.POST_HOST}ns/oauth2/access_token?appid=APPID&secret=SECRET&code=${code}&grant_type=authorization_code`;
	}
}
